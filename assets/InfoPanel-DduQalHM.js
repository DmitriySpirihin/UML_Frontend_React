import{A as S,cY as B,j as t,k as H,z as P,B as z,D as A,E as O,G,n as L,t as U,l as W,f as N,m as b,d as Y,C as v}from"./index-DZO043SI.js";import{r as p}from"./recharts-k8ghPecL.js";const J=()=>{const[n,a]=p.useState(()=>S?.prefs?.[1]===0?"dark":"light"),[s,o]=p.useState(()=>S?.prefs?.[0]??0),[e,i]=p.useState(0),[r,c]=p.useState("MainCard");p.useEffect(()=>{const l=B.subscribe(c);return()=>l.unsubscribe()},[]);const u=p.useMemo(()=>[{id:"MainCard",icon:t.jsx(H,{}),title:s===0?"Общее":"General",color:"#404040"},{id:"HabitsMain",icon:t.jsx(P,{}),title:s===0?"Привычки":"Habits",color:"#FFD700"},{id:"TrainingMain",icon:t.jsx(z,{}),title:s===0?"Тренировки":"Workout",color:"#FF4D4D"},{id:"MentalMain",icon:t.jsx(A,{}),title:s===0?"Мозг":"Brain",color:"#4DA6FF"},{id:"RecoveryMain",icon:t.jsx(O,{}),title:s===0?"Восстановление":"Recovery",color:"#4DFF88"},{id:"SleepMain",icon:t.jsx(G,{}),title:s===0?"Сон":"Sleep",color:"#A64DFF"},{id:"ToDoMain",icon:t.jsx(L,{}),title:s===0?"Задачи":"To-Do",color:"#FFA64D"}],[s]);p.useEffect(()=>{const l=U.subscribe(a),x=W.subscribe(y=>o(y==="ru"?0:1)),f=N.subscribe(i);return()=>{l.unsubscribe(),x.unsubscribe(),f.unsubscribe()}},[]);const d=_(n,e),g=p.useMemo(()=>u.find(x=>x.id===r)?.color||"#6E6E6E",[u,r]),h=p.useMemo(()=>({MainCard:"images/bro.png",HabitsMain:"images/bro_habits.png",TrainingMain:"images/bro_training.png",MentalMain:"images/bro_mind.png",RecoveryMain:"images/bro_meditating.png",SleepMain:"images/bro_sleeping.png",ToDoMain:"images/bro_task.png"}),[])[r]||guideMain,m=r==="HabitsMain"?{transform:"scale(1.15) translateY(6px)"}:{transform:"scale(1.05) translateY(2px)"},T=p.useMemo(()=>{const l=V(n),x=Q(s,r,g);return`<style>${l}</style>${x}`},[n,s,r,g]);return t.jsxs("div",{style:d.container,children:[t.jsxs("div",{style:d.header,children:[t.jsxs("div",{style:d.topBar,children:[t.jsx("span",{style:d.headerTitle,children:s===0?"Инструкция":"User Guide"}),t.jsx("div",{style:{width:40}})]}),t.jsx("div",{style:d.tabsContainer,className:"no-scrollbar",children:u.map(l=>{const x=r===l.id;return t.jsxs(b.div,{onClick:()=>c(l.id),style:d.tabItem(x,l.color),whileTap:{scale:.95},children:[t.jsx("div",{style:{fontSize:"18px",display:"flex"},children:l.icon}),x&&t.jsx(b.span,{initial:{opacity:0,width:0},animate:{opacity:1,width:"auto"},style:d.tabText,children:l.title})]},l.id)})})]}),t.jsxs("div",{style:d.scrollView,className:"no-scrollbar",children:[t.jsx(Y,{mode:"wait",children:t.jsxs(b.div,{initial:{opacity:0,y:10},animate:{opacity:1,y:0},exit:{opacity:0,y:-10},transition:{duration:.18},style:d.contentContainer,children:[t.jsxs(b.div,{initial:{opacity:0,y:8},animate:{opacity:1,y:0},transition:{duration:.22},style:d.coachRow,children:[t.jsx(b.img,{src:h,alt:"Guide",style:{...d.coachImg,...m},animate:{y:[0,-3,0]},transition:{duration:2.8,repeat:1/0,ease:"easeInOut"}},h),t.jsxs("div",{style:d.speech,children:[t.jsx("div",{style:d.speechTitle,children:s===0?"UltyMyBro:":"Guide:"}),t.jsx("div",{style:d.speechText,children:q(s,r)}),t.jsx("div",{style:d.speechTail})]})]}),t.jsx("div",{style:d.htmlContent,dangerouslySetInnerHTML:{__html:T}})]},r)}),t.jsx("div",{style:{height:"110px"}})]})]})};function _(n,a){const s=v.get("background",n),o=v.get("mainText",n),e=v.get("subText",n),i=v.get("simplePanel",n),r=v.get("border",n);return{container:{backgroundColor:s,display:"flex",flexDirection:"column",height:"90vh",marginTop:"100px",width:"100vw",fontFamily:"Segoe UI, system-ui, -apple-system, sans-serif",overflow:"hidden"},header:{width:"100%",backgroundColor:s,paddingTop:"40px",borderBottom:`1px solid ${r}`,zIndex:10},topBar:{display:"flex",width:"100%",alignItems:"center",justifyContent:"center",padding:"0 20px 15px 20px",boxSizing:"border-box"},headerTitle:{fontSize:"20px",fontWeight:"900",color:o,letterSpacing:"0.2px"},tabsContainer:{display:"flex",gap:"10px",padding:"0 20px 15px 20px",overflowX:"auto",width:"100%",boxSizing:"border-box"},tabItem:(c,u)=>({padding:c?"8px 16px":"8px 12px",borderRadius:"999px",backgroundColor:c?u:i,color:c?"#FFF":e,display:"flex",alignItems:"center",gap:"8px",cursor:"pointer",flexShrink:0,transition:"background-color 0.25s ease",border:c?"none":`1px solid ${r}`,boxShadow:c?"0 10px 22px rgba(0,0,0,0.18)":"none"}),tabText:{fontSize:"14px",fontWeight:"800",whiteSpace:"nowrap",overflow:"hidden"},scrollView:{flex:1,width:"100%",overflowY:"auto",padding:"18px 18px",boxSizing:"border-box"},contentContainer:{width:"100%",maxWidth:"660px",margin:"0 auto"},coachRow:{width:"100%",display:"flex",alignItems:"center",gap:"14px",marginBottom:"14px"},coachImg:{width:"96px",height:"96px",objectFit:"contain",flexShrink:0,filter:n==="dark"?"drop-shadow(0 16px 22px rgba(0,0,0,0.60))":"drop-shadow(0 12px 18px rgba(0,0,0,0.12))"},speech:{position:"relative",flex:1,backgroundColor:i,border:`1px solid ${r}55`,borderRadius:"18px",padding:"12px 14px",boxShadow:n==="dark"?"0 14px 34px rgba(0,0,0,0.42)":"0 10px 26px rgba(0,0,0,0.08)"},speechTitle:{fontSize:"12px",fontWeight:900,color:e,opacity:.75,marginBottom:"6px"},speechText:{fontSize:a===0?"14px":"16px",fontWeight:800,color:o,lineHeight:1.35},speechTail:{position:"absolute",left:"-8px",bottom:"18px",width:"14px",height:"14px",backgroundColor:i,borderLeft:`1px solid ${r}55`,borderBottom:`1px solid ${r}55`,transform:"rotate(45deg)",borderBottomLeftRadius:"4px"},htmlContent:{width:"100%",backgroundColor:n==="dark"?"rgba(255,255,255,0.03)":"rgba(0,0,0,0.03)",border:`1px solid ${r}55`,borderRadius:"22px",padding:"16px 16px",boxShadow:n==="dark"?"0 22px 60px rgba(0,0,0,0.52)":"0 14px 34px rgba(0,0,0,0.10)",color:o,lineHeight:1.55,fontSize:a===0?"15px":"17px",boxSizing:"border-box",overflow:"hidden"}}}function q(n,a){const s=n===0;return(s?{MainCard:"Сверху вкладки — это телепорт по разделам",HabitsMain:"Привычки — это автопилот",TrainingMain:"Тренировки — это доказательства, а не ощущения",MentalMain:"Мозг — это мини-игры: выбери режим, уровень и жми «Начать» ",RecoveryMain:"Восстановление — это быстрый сброс стресса",SleepMain:"Сон — это чит-код жизни ",ToDoMain:"Задачи — это порядок в голове"}:{MainCard:"At the top of the tab is a teleport across sections",HabitsMain:"Habits are an autopilot",TrainingMain:"Workouts are proofs, not sensations",MentalMain:"The brain is a mini-game: select the mode, level and click 'Start'",RecoveryMain:"Recovery is a quick stress relief",SleepMain:"Sleep is the cheat code of life",ToDoMain:"Tasks are an order in the head"})[a]||(s?"Инструкция в разработке…":"Guide coming soon…")}function Q(n,a,s){const o=n===0,e=(M,w,k,I,E,D,F="")=>`

import{r as p,j as a,U as H,A as P,Z as B,_ as z,$ as A,a0 as O,V as U}from"./react-core-DTJfGpvQ.js";import{A as S,t as G,l as L,f as W,C as b}from"./index-DSJZFJxf.js";import{m as v,A as N}from"./framer-motion-QoxkE90y.js";import"./vendor-RoreSCww.js";import"./ton-sdk-DGogAMH-.js";const ii=()=>{const[n,t]=p.useState(()=>S?.prefs?.[1]===0?"dark":"light"),[s,o]=p.useState(()=>S?.prefs?.[0]??0),[e,i]=p.useState(0),[r,x]=p.useState("MainCard"),u=p.useMemo(()=>[{id:"MainCard",icon:a.jsx(H,{}),title:s===0?"Общее":"General",color:"#404040"},{id:"HabitsMain",icon:a.jsx(P,{}),title:s===0?"Привычки":"Habits",color:"#FFD700"},{id:"TrainingMain",icon:a.jsx(B,{}),title:s===0?"Тренировки":"Workout",color:"#FF4D4D"},{id:"MentalMain",icon:a.jsx(z,{}),title:s===0?"Мозг":"Brain",color:"#4DA6FF"},{id:"RecoveryMain",icon:a.jsx(A,{}),title:s===0?"Восстановление":"Recovery",color:"#4DFF88"},{id:"SleepMain",icon:a.jsx(O,{}),title:s===0?"Сон":"Sleep",color:"#A64DFF"},{id:"ToDoMain",icon:a.jsx(U,{}),title:s===0?"Задачи":"To-Do",color:"#FFA64D"}],[s]);p.useEffect(()=>{const l=G.subscribe(t),c=L.subscribe(y=>o(y==="ru"?0:1)),f=W.subscribe(i);return()=>{l.unsubscribe(),c.unsubscribe(),f.unsubscribe()}},[]);const d=Y(n,e),g=p.useMemo(()=>u.find(c=>c.id===r)?.color||"#6E6E6E",[u,r]),h=p.useMemo(()=>({MainCard:"images/bro.png",HabitsMain:"images/bro_habits.png",TrainingMain:"images/bro_training.png",MentalMain:"images/bro_mind.png",RecoveryMain:"images/bro_meditating.png",SleepMain:"images/bro_sleeping.png",ToDoMain:"images/bro_task.png"}),[])[r]||guideMain,m=r==="HabitsMain"?{transform:"scale(1.15) translateY(6px)"}:{transform:"scale(1.05) translateY(2px)"},T=p.useMemo(()=>{const l=Q(n),c=q(s,r,g);return`<style>${l}</style>${c}`},[n,s,r,g]);return a.jsxs("div",{style:d.container,children:[a.jsxs("div",{style:d.header,children:[a.jsxs("div",{style:d.topBar,children:[a.jsx("span",{style:d.headerTitle,children:s===0?"Инструкция":"User Guide"}),a.jsx("div",{style:{width:40}})]}),a.jsx("div",{style:d.tabsContainer,className:"no-scrollbar",children:u.map(l=>{const c=r===l.id;return a.jsxs(v.div,{onClick:()=>x(l.id),style:d.tabItem(c,l.color),whileTap:{scale:.95},children:[a.jsx("div",{style:{fontSize:"18px",display:"flex"},children:l.icon}),c&&a.jsx(v.span,{initial:{opacity:0,width:0},animate:{opacity:1,width:"auto"},style:d.tabText,children:l.title})]},l.id)})})]}),a.jsxs("div",{style:d.scrollView,className:"no-scrollbar",children:[a.jsx(N,{mode:"wait",children:a.jsxs(v.div,{initial:{opacity:0,y:10},animate:{opacity:1,y:0},exit:{opacity:0,y:-10},transition:{duration:.18},style:d.contentContainer,children:[a.jsxs(v.div,{initial:{opacity:0,y:8},animate:{opacity:1,y:0},transition:{duration:.22},style:d.coachRow,children:[a.jsx(v.img,{src:h,alt:"Guide",style:{...d.coachImg,...m},animate:{y:[0,-3,0]},transition:{duration:2.8,repeat:1/0,ease:"easeInOut"}},h),a.jsxs("div",{style:d.speech,children:[a.jsx("div",{style:d.speechTitle,children:s===0?"UltyMyBro:":"Guide:"}),a.jsx("div",{style:d.speechText,children:_(s,r)}),a.jsx("div",{style:d.speechTail})]})]}),a.jsx("div",{style:d.htmlContent,dangerouslySetInnerHTML:{__html:T}})]},r)}),a.jsx("div",{style:{height:"110px"}})]})]})};function Y(n,t){const s=b.get("background",n),o=b.get("mainText",n),e=b.get("subText",n),i=b.get("simplePanel",n),r=b.get("border",n);return{container:{backgroundColor:s,display:"flex",flexDirection:"column",height:"90vh",marginTop:"100px",width:"100vw",fontFamily:"Segoe UI, system-ui, -apple-system, sans-serif",overflow:"hidden"},header:{width:"100%",backgroundColor:s,paddingTop:"40px",borderBottom:`1px solid ${r}`,zIndex:10},topBar:{display:"flex",width:"100%",alignItems:"center",justifyContent:"center",padding:"0 20px 15px 20px",boxSizing:"border-box"},headerTitle:{fontSize:"20px",fontWeight:"900",color:o,letterSpacing:"0.2px"},tabsContainer:{display:"flex",gap:"10px",padding:"0 20px 15px 20px",overflowX:"auto",width:"100%",boxSizing:"border-box"},tabItem:(x,u)=>({padding:x?"8px 16px":"8px 12px",borderRadius:"999px",backgroundColor:x?u:i,color:x?"#FFF":e,display:"flex",alignItems:"center",gap:"8px",cursor:"pointer",flexShrink:0,transition:"background-color 0.25s ease",border:x?"none":`1px solid ${r}`,boxShadow:x?"0 10px 22px rgba(0,0,0,0.18)":"none"}),tabText:{fontSize:"14px",fontWeight:"800",whiteSpace:"nowrap",overflow:"hidden"},scrollView:{flex:1,width:"100%",overflowY:"auto",padding:"18px 18px",boxSizing:"border-box"},contentContainer:{width:"100%",maxWidth:"660px",margin:"0 auto"},coachRow:{width:"100%",display:"flex",alignItems:"center",gap:"14px",marginBottom:"14px"},coachImg:{width:"96px",height:"96px",objectFit:"contain",flexShrink:0,filter:n==="dark"?"drop-shadow(0 16px 22px rgba(0,0,0,0.60))":"drop-shadow(0 12px 18px rgba(0,0,0,0.12))"},speech:{position:"relative",flex:1,backgroundColor:i,border:`1px solid ${r}55`,borderRadius:"18px",padding:"12px 14px",boxShadow:n==="dark"?"0 14px 34px rgba(0,0,0,0.42)":"0 10px 26px rgba(0,0,0,0.08)"},speechTitle:{fontSize:"12px",fontWeight:900,color:e,opacity:.75,marginBottom:"6px"},speechText:{fontSize:t===0?"14px":"16px",fontWeight:800,color:o,lineHeight:1.35},speechTail:{position:"absolute",left:"-8px",bottom:"18px",width:"14px",height:"14px",backgroundColor:i,borderLeft:`1px solid ${r}55`,borderBottom:`1px solid ${r}55`,transform:"rotate(45deg)",borderBottomLeftRadius:"4px"},htmlContent:{width:"100%",backgroundColor:n==="dark"?"rgba(255,255,255,0.03)":"rgba(0,0,0,0.03)",border:`1px solid ${r}55`,borderRadius:"22px",padding:"16px 16px",boxShadow:n==="dark"?"0 22px 60px rgba(0,0,0,0.52)":"0 14px 34px rgba(0,0,0,0.10)",color:o,lineHeight:1.55,fontSize:t===0?"15px":"17px",boxSizing:"border-box",overflow:"hidden"}}}function _(n,t){const s=n===0;return(s?{MainCard:"Сверху вкладки — это телепорт по разделам",HabitsMain:"Привычки — это автопилот",TrainingMain:"Тренировки — это доказательства, а не ощущения",MentalMain:"Мозг — это мини-игры: выбери режим, уровень и жми «Начать» ",RecoveryMain:"Восстановление — это быстрый сброс стресса",SleepMain:"Сон — это чит-код жизни ",ToDoMain:"Задачи — это порядок в голове"}:{MainCard:"At the top of the tab is a teleport across sections",HabitsMain:"Habits are an autopilot",TrainingMain:"Workouts are proofs, not sensations",MentalMain:"The brain is a mini-game: select the mode, level and click 'Start'",RecoveryMain:"Recovery is a quick stress relief",SleepMain:"Sleep is the cheat code of life",ToDoMain:"Tasks are an order in the head"})[t]||(s?"Инструкция в разработке…":"Guide coming soon…")}function q(n,t,s){const o=n===0,e=(M,w,k,I,E,D,F="")=>`
  ...
  `),f=e("Sleep","Track 3 fields and discover what truly impacts your energy","SLEEP LOG","30 sec",[i("1","Pick a day on the calendar","Tap a date. Fill height = duration, color = mood."),i("2","Add a sleep entry","Set Bedtime + Duration (3–14h) + Mood (1–5)."),i("3","Add a note (optional)","Caffeine/workout/stress/screens/alcohol/awakenings — helps insights later."),i("4","Save and view the day card","You’ll see bedtime, duration, mood stars, and the note.")].join(""),'<div class="uxTipIcon">🌙</div><div class="uxTipText"><b>Rule:</b> you can’t log sleep for future dates.</div>'),y=e("Задачи","Порядок в голове — скорость в жизни","TO-DO","каждый день",[i("1","Добавь задачи",'Нажми <span class="uxChip uxChipPlus">＋</span> и запиши всё, что давит на мозг.'),i("2","Выбери приоритеты","Оставь 1–3 главных на сегодня. Остальное — вторично."),i("3","Дроби и закрывай","Разбей большую задачу на маленькие шаги и закрывай по одному.")].join(""),'<div class="uxTipIcon">✅</div><div class="uxTipText">Формула дня: <b>1 важное</b> + <b>1 полезное</b> + <b>1 быстрое</b>.</div>',`
    ...
    `),$=e("To-Do","A clean mind moves faster","TO-DO","daily",[i("1","Add tasks",'Tap <span class="uxChip uxChipPlus">＋</span> and dump what’s on your mind.'),i("2","Pick priorities","Keep 1–3 main tasks for today."),i("3","Break & finish","Split big tasks into small steps and close them one by one.")].join(""),'<div class="uxTipIcon">✅</div><div class="uxTipText">Daily formula: <b>1 important</b> + <b>1 useful</b> + <b>1 quick win</b>.</div>'),R=e("Скоро","Инструкция для этого раздела сейчас допиливается","IN PROGRESS","",i("1","Чуть-чуть терпения","Сейчас доделаем “Привычки”, потом пойдём по вкладкам дальше."),'<div class="uxTipIcon">●</div><div class="uxTipText">Пока ориентир простой: вкладки сверху → читаешь → делаешь.</div>'),j=e("Coming Soon","Guide for this section is being polished","IN PROGRESS","",i("1","A bit of patience","We’ll finish Habits first, then continue tab by tab."),'<div class="uxTipIcon">●</div><div class="uxTipText">For now: top tabs → read → do.</div>');switch(t){case"MainCard":return o?r:x;case"HabitsMain":return o?u:d;case"TrainingMain":return o?g:C;case"MentalMain":return o?h:m;default:return o?R:j;case"RecoveryMain":return o?T:l;case"SleepMain":return o?c:f;case"ToDoMain":return o?y:$}}function Q(n){const t=n==="dark",s=t?"rgba(255,255,255,0.92)":"rgba(10,10,10,0.92)",o=t?"rgba(255,255,255,0.58)":"rgba(10,10,10,0.55)",e=t?"rgba(255,255,255,0.10)":"rgba(0,0,0,0.08)";return`
    .ux{ width:100%; }
    ...
    .uxHero{
      ...
      border-radius: 24px;
      border: 1px solid ${e};
      background: linear-gradient(180deg, ${t?"rgba(255,255,255,0.05)":"rgba(255,255,255,0.75)"}, ${t?"rgba(255,255,255,0.03)":"rgba(255,255,255,0.55)"});
      box-shadow: ${t?"0 28px 70px rgba(0,0,0,0.60)":"0 20px 50px rgba(0,0,0,0.12)"};
    ...
    .uxBadge{
      ...
      border-radius: 999px;
      border: 1px solid ${e};
      background: ${t?"rgba(255,255,255,0.05)":"rgba(255,255,255,0.60)"};
      color: ${s};
      letter-spacing: .3px;
    ...
    .uxStep{
      ...
      padding: 12px 12px;
      border-radius: 18px;
      border: 1px solid ${t?"rgba(255,255,255,0.08)":"rgba(0,0,0,0.06)"};
      background: ${t?"rgba(0,0,0,0.18)":"rgba(255,255,255,0.55)"};
    }
    ...
    .uxNum{
      ...
      color: ${s};
      border: 1px solid ${e};
      background: ${t?"rgba(255,255,255,0.06)":"rgba(255,255,255,0.70)"};
      box-shadow: ${t?"0 10px 18px rgba(0,0,0,0.45)":"0 10px 18px rgba(0,0,0,0.10)"};
      flex-shrink: 0;
    }
    ...
    .uxChipOk{
      background: ${t?"rgba(90,255,170,0.14)":"rgba(90,255,170,0.10)"};
    }

    .uxDivider{
      height: 1px;
      background: ${t?"rgba(255,255,255,0.08)":"rgba(0,0,0,0.07)"};
    ...
    .uxTip{
      ...
      border-radius: 18px;
      border: 1px dashed ${e};
      background: ${t?"rgba(255,255,255,0.04)":"rgba(255,255,255,0.60)"};
    }
    ...
    .uxTipIcon{
      ...
      justify-content:center;
      border: 1px solid ${e};
      color: ${t?"rgba(255,255,255,0.80)":"rgba(0,0,0,0.55)"};
      background: color-mix(in srgb, var(--accent) 16%, ${t?"rgba(0,0,0,0.18)":"rgba(255,255,255,0.85)"});
      flex-shrink: 0;
    }
    ...
    .uxMiniCard{
      border-radius: 18px;
      border: 1px solid ${e};
      background: ${t?"rgba(255,255,255,0.03)":"rgba(255,255,255,0.65)"};
      padding: 12px 12px;
      box-shadow: ${t?"0 16px 40px rgba(0,0,0,0.40)":"0 12px 30px rgba(0,0,0,0.08)"};
    }

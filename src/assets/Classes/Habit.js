...
export class Habit
{
    ...
    constructor(n = ["Привычка","Habit"],c = ["Другое","Other"],d = ["Своя привычка","My custom habit"],
        id,isCustom = false,src = 'images/HabitsIcons/Default.png')
    {
        if(Array.isArray(n))
        {
           this.name = n;
        ...
        image.onerror = () => {
            this.src = 'images/HabitsIcons/Default.png';
        }
    }
}
...
const DefaultHabits = [
    ...
    ["Читать каждый день","Read every day"],3,false,path + 'Default.png'),
    new Habit(["10 000 шагов","10,000 steps"],["Здоровье","Health"],
    ["Пройти не менее 10 000 шагов","Walk at least 10,000 steps"],4,false,path + 'Default.png'),
    new Habit(["Спать 8 часов","Sleep 8 hours"],["Здоровье","Health"],
    ["Ложиться вовремя и спать 8 часов","Go to bed on time and sleep 8 hours"],5,false,path + 'Default.png'),
    new Habit(["Без сахара","No sugar"],["Здоровье","Health"],
    ["Избегать сахара сегодня","Avoid sugar today"],6,false,path + 'Default.png'),
    new Habit(["Ведение дневника","Journaling"],["Развитие","Growth"],
    ["Записать мысли и итоги дня","Write thoughts and daily summary"],7,false,path + 'Default.png'),
    new Habit(["План на день","Plan the day"],["Продуктивность","Productivity"],
    ["Составить список задач на день","Create a to-do list for the day"],8,false,path + 'Default.png'),
    new Habit(["Английский 30 минут","English 30 minutes"],["Обучение","Learning"],
    ["Позаниматься английским языком 30 минут","Study English for 30 minutes"],9,false,path + 'Default.png'),
    new Habit(["Убрать рабочее место","Tidy workspace"],["Дом","Home"],
    ["Навести порядок на рабочем столе","Organize your desk"],10,false,path + 'Default.png'),
    new Habit(["Отжимания 20 раз","20 push-ups"],["Фитнес","Fitness"],
    ["Сделать 20 отжиманий","Do 20 push-ups"],11,false,path + 'Default.png'),
    ...
    ["Пробежать 3 километра","Run 3 kilometers"],13,false,path + 'Default' + '.png'),
    ...
    ["Практика программирования 1 час","Practice coding for 1 hour"],16,false,path + 'Default' + '.png'),
    new Habit(["Повторить слова","Review vocabulary"],["Обучение","Learning"],
    ["Повторить слова в словаре","Review vocabulary words"],17,false,path + 'Default' + '.png'),
    new Habit(["Без соцсетей 1 час","No social media 1 hour"],["Продуктивность","Productivity"],
    ["Избегать соцсетей как минимум 1 час","Avoid social media for at least 1 hour"],18,false,path + 'Default' + '.png'),
    new Habit(["Проверить бюджет","Review budget"],["Финансы","Finance"],
    ["Проверить расходы и бюджет","Review expenses and budget"],19,false,path + 'Default' + '.png'),
    new Habit(["Позвонить близким","Call family"],["Отношения","Relationships"],
    ["Связаться с родными или друзьями","Reach out to family or friends"],20,false,path + 'Default' + '.png'),
    new Habit(["Растяжка перед сном","Evening stretch"],["Здоровье","Health"],
    ["Сделать растяжку перед сном","Do a stretching routine before bed"],21,false,path + 'Default' + '.png'),
    ...
    ["Погулять на улице 20 минут","Take a 20-minute walk"],23,false,path + 'Default.png'),
    new Habit(["Свежий воздух","Get fresh air"],["Здоровье","Health"],
    ["Провести время на свежем воздухе","Spend time outdoors"],24,false,path + 'Default.png'),
    new Habit(["Заправить кровать","Make the bed"],["Дом","Home"],
    ["Заправить кровать утром","Make your bed in the morning"],25,false,path + 'Default.png'),
]

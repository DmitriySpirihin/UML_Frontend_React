...
export class Colors {
  ...
  static palette = {
    ...
    highlitedPanel: { light: "#698198ff", dark: "#332b3bff", speciallight: "#994b83ff", specialdark: "#427042ff" },
    ...
    border: { light: "#576c7eff", dark: "#88a0c6ff", speciallight: "#ffffffff", specialdark: "#d3e3d3ff" },
    shadow: { light: "#828eaaff", dark: "#000000ff", speciallight: "#522323ff", specialdark: "#505635ff" },
    bottomPanel: { light: "#c5d9ebff", dark: "#1c1b1dff", speciallight: "#e8b7aeff", specialdark: "#181414ff" },
    bottomPanelShadow: { light: "#8b9cc6ff", dark: "#868787ff", speciallight: "#fffdfcff", specialdark: "#38483dff" },

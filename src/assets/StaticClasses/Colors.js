...
export class Colors {
  ...
  static palette = {
    ...
    border: { light: "#576c7eff", dark: "#4a6266ff", speciallight: "#e8d9d9ff", specialdark: "#d3e3d3ff" },
    ...
    currentDateBorder2: { light: "#6daae0ff", dark: "#0f1f1dff", speciallight: "#d581a1ff", specialdark: "#1a291aff" },
    progressBar:{ light: "#46555bff", dark: "#0d0f12ff", speciallight: "#6b5150ff", specialdark: "#171313ff" },

    icons:{ light: "#525e69ff", dark: "#616568ff", speciallight: "#d78282ff", specialdark: "#546654ff" },

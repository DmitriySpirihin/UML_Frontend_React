...
const HABIT_TABLER_ICONS = {
    ...
    detox: tablerIcon(TbShield),
    sugar: tablerIcon(TbSoup),
    late: tablerIcon(TbClock),
    screen: tablerIcon(TbDeviceMobile),
    smoke: tablerIcon(TbSmokingNo),
    alcohol: tablerIcon(TbGlassFull),
